            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nama.isEmpty()) {
                    ...
                    if (confirmation == JOptionPane.YES_OPTION) {
                        ...
                        tableModel.add(new ArrayList<>(Arrays.asList(nama, jenisKelamin, nomorHP, alamatRumah)));
                ...
                if (table.getSelectedRowCount() == 1) {
                    ...
                    if (nama.isEmpty()) {
                        ...
                        if (confirmation == JOptionPane.YES_OPTION) {
                            ...
                            table.setValueAt(nama, table.getSelectedRow(), 0);
                            table.setValueAt(jenisKelamin, table.getSelectedRow(), 1);
                            table.setValueAt(nomorHP, table.getSelectedRow(), 2);
                            table.setValueAt(alamatRumah, table.getSelectedRow(), 3);
